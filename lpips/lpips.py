...
class LPIPS(nn.Module):
    def __init__(self, pretrained = True, net = 'alex', version = '0.1', lpips = True, spatial = False,
                 ...
                 verbose = True):
        """ Initializes a perceptual lpips_loss torch.nn.Module
        ...
        if (verbose):
            print('Setting up [%s] perceptual lpips_loss: trunk [%s], v[%s], spatial [%s]' %
    ...
    def get_feature(self, in0):
        in0_input = self.scaling_layer(in0)
        outs0 = self.net.forward(in0_input)
        return outs0

    def forward(self, in0, in1, retPerLayer = False, normalize = False, isFeature = False, spatial = False):
        self.spatial = spatial
